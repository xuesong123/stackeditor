...
NodeBarView.prototype.hls = function(view) {
    ...
    this.backbar.style.top = (y / zoom).toFixed(2) + "px";
    this.backbar.style.left = (x / zoom).toFixed(2) + "px";
    this.backbar.style.width = (w / zoom).toFixed(2) + "px";
    this.backbar.style.height = (h / zoom).toFixed(2) + "px";
    this.backbar.style.display = (this.hlsb ? "block" : "none");
};

NodeBarView.prototype.getZoom = function(e) {
